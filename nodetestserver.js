...
var generateWidgetDocs = function() {
  ...
  html += `
    ...
    <body style="padding:20px;">
      ...
      <h1 class="page-header" style="margin-top:0;">ChiliPeppr Widget Docs</h1>
  ...
  your widget out of widjet.js, widjet.css, and widget.html.
  </p>
      
  <p>When this page is executed from NodeJs this page will combine 
  those files into a monolithic HTML file with
  CSS and Javascript inlined called auto-generated-widget.html. This script
  will also push to your forked repo on Github whenever it is run so that Github is as up-to-date
  as possible.</p>
